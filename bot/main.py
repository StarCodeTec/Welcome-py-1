...
@tasks.loop(time=[datetime.time(hour=6, minute=0, second=0, microsecond=0), datetime.time(hour=9, minute=0, second=0, microsecond=0), (hour= minute=0, second=0, microsecond=0), datetime.time(hour=15, minute=0, second=0, microsecond=0), datetime.time(hour=18, minute=0, second=0, microsecond=0), datetime.time(hour=21, minute=0, second=0, microsecond=0), datetime.time(hour=24, minute=0, second=0, microsecond=0)], count=None)
async def bystander():
